...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT( \
    ...
    KC_LSFT,      KC_Z,   KC_X,  KC_C,   KC_V,   KC_B,      KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  KC_UP,  MO(_ADJUST),  \
    KC_ESC,  KC_LGUI,    KC_LALT,    KC_LANG2,   KC_SPC,    KC_BSPC,   KC_LANG1,   KC_RCTL,            KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [_META] = LAYOUT( \
    ...
    _______,     _______, _______, _______, _______,  _______,   KC_BSPC,  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_DEL,  _______, \
