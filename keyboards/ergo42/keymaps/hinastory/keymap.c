...
#define KC_AESC LT(MO(ADJUST), KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* BASE
   * ,------------------------------------------------.   ,------------------------------------------------.
   * | AESC |  Tab |   Q  |   W  |   E  |   R  |  T   |   |  Y   |   U  |   I  |   O  |   P  |  -   |   \  |
   * |------+------+------+------+------+------+------|   |-------------+------+------+------+------+------|
   * | GGui | Ctrl |   A  |   S  |   D  |   F  |  G   |   |  H   |   J  |   K  |   L  |   ;  |  '   | Enter|
   * |------+------+------+------+------+------+------|   |------|------+------+------+------+------+------|
   * | LAlt | LSFT |   Z  |   X  |   C  |   V  |  B   |   |  N   |   M  |   ,  |   .  |   /  |  =   | RSft |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * |  1   |   2  |   3  |   4  |   5  |LOWER | MSpc |   | Bapc | RAISE|   6  |   7  |   8  |  9   |  0   |
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [BASE] = LAYOUT( \
    KC_AESC, KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,KC_MINUS,  KC_BSLS, \
  ...
  [META] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, XXXXXXX,  KC_DEL, _______, \
  ...
  [NUMPAD] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_LBRC,  KC_RBRC,  KC_COMM,    KC_4,    KC_5,    KC_6, _______, \
    _______, _______, _______, _______, _______, _______, _______, S(KC_LBRC),S(KC_RBRC), KC_0,    KC_1,    KC_2,    KC_3, _______, \
